...
public class MatchController {
    ...
    @PostMapping("/list")
    public String getMatchList(@Validated @ModelAttribute("match") SearchDateDto dto, BindingResult bindingResult
        ...
        MatchDto matchDto = matchService.searchMatchListByDate(dto.getStart(), dto.getEnd(), nickname);
